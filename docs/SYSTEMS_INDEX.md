...
**Details:** `docs/design-system/BUTTONS.md` — 16 قسماً: BTN-00 (Routing) → BTN-16 (Forbidden Patterns)
**Do not recreate:** لا تكتب منطق زر خارج هذا الـ contract. لا تُنشئ `tw-ui-tokens.css` حتى يُطلب صراحةً. لا تُعيد تعريف ألوان الأزرار خارج design tokens الموجودة (`--ac`, `--ac2`, `--bg`). أي زر جديد يبدأ بقراءة BTN-00 (Routing Contract) ثم الأقسام المناسبة.
