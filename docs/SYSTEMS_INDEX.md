...
### 19. Notifications System ✅ (Phases 0–10 complete · Phase 11 deferred · V2 complete PRs #447–#453)
**Purpose:** User notifications for messages, job applications, verification status, profile activity. Includes hooks for comment / reply / mention / job-apply / follow / verify actions. Unread badge in app header via polling. V2 Smart Aggregation for follow, job application, comment, and reply hooks.
