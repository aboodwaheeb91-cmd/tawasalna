...
**Purpose:** الـ contract المعماري الرسمي لكل حقول التاريخ والوقت في منصة تواصلنا — 7 أنواع رسمية (Year-only / Month+Year / Full Date / Open-ended Range / Time / DateTime / Timezone Boundary)، Data Precision Contract (لا قيم وهمية)، Temporal Dependency (Leap Year + Start/End Range + Parent-Change Cascade)، Serialization ≠ UI، Hydration ordering، No Auto-select، Open-ended "حتى الآن" = null، State Model (4 محاور مستقلة)، Legacy Migration Inventory، Forbidden Patterns.
...
**Details:** `docs/design-system/DATE-TIME-FIELDS.md` — 36 قسماً: DATE-00 (Routing Protocol) → DATE-35 (Out of Scope).
أبرز قواعد:
