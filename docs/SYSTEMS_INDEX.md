...
**Details:** `docs/CHANGE_ROUTER.md` — Workflow Order · Constitutional Position · CRS-01 (Scope Detection → 17 Change Types → Owner Resolution procedure → Required Reading) · CRS-02 (Sanity Check) · System Gap Contract · Shared System First (F30-based) · CRS-03 (TINY/MEDIUM/ARCHITECTURAL) · Context Reuse · Ambiguity/Confidence · Impact Matrix · Mobile/API-First Guard · Notification Routing · User Intent ≠ Implementation Method · Audit/Execution Modes · No Auto-Fix · Standard Output Format · Mandatory Architectural Opinion
