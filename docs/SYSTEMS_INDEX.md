...
**Status:** 🔜 قرار معماري موثَّق — لا كود، لا schema، لا endpoints، لا background jobs. أي تنفيذ يحتاج موافقة صريحة من المستخدم + PR مخصص.
