...
- S6-cron ✅ External Cron مفعَّل (PR: scheduler-cron-activation) — `.github/workflows/scheduler-cron.yml`، كل 5 دقائق، POST /internal/run-due-jobs + X-Scheduler-Secret. يتطلب: Heroku Config Var SCHEDULER_SECRET + GitHub Secret SCHEDULER_SECRET + GitHub Variable APP_URL.
