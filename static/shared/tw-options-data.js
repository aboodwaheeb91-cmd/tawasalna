...
(function () {
  ...
  // ── Job categories — aligned with Profile V2 specialty taxonomy ──
  TW.JOB_CATEGORIES = [
    'تقنية وبرمجة','هندسة','صحة وطب',
    'تعليم وتدريب','إبداع وتصميم','مبيعات وتسويق',
    'محاسبة ومالية','إداري ومكتبي','موارد بشرية',
    'مهن وحرف','خدمات وضيافة','سائقون وتوصيل',
    'أمن وحماية','أخرى'
  ];
