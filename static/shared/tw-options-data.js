...
(function () {
  ...
  // ── Post tags catalog (controlled vocabulary — UI enforced) ─────
  TW.POST_TAGS = [
    // توظيف وشواغر
    'توظيف','فرصة عمل','شواغر','وظائف','إعلان توظيف',
    'قبول طلبات','استقبال طلبات','تعيينات','مقابلات','مقابلات عمل',
    'دعوة مقابلة','فرص وظيفية','يوم وظيفي','معرض توظيف',
    'فرص للخريجين','فرص للطلاب','فرص للشباب',
    'وظائف للجنسين','وظائف نسائية','وظائف للذكور',
    // أنواع الوظائف
    'وظيفة بدوام كامل','وظيفة بدوام جزئي','وظيفة مؤقتة','وظيفة موسمية',
    'وظيفة عن بعد','وظيفة حضورية','وظيفة هجينة','تدريب منتهي بالتوظيف',
    'بدون خبرة','خبرة مطلوبة',
    // إدارة شواغر
    'آخر موعد للتقديم','تمديد التقديم','إغلاق التقديم','إغلاق شواغر',
    'نتائج مقابلات','أسماء مقبولين','قائمة مرشحين',
    // أخبار
    'خبر','أخبار','خبر مهم','خبر عاجل','أخبار الشركة','أخبار المؤسسة',
    'أخبار السوق','أخبار التعليم','أخبار التدريب',
    // إعلانات وتنبيهات
    'إعلان','إعلان هام','إعلان رسمي','تنبيه','تحديث','توضيح',
    'بيان','بيان رسمي','تعميم','إشعار','ملاحظة','مستجدات','جديد الشركة','قرار','إعلام',
    // إنجازات
    'إنجاز','نجاح','قصة نجاح','إنجاز جديد','إنجازات','تميز','تطور','تقدم','نمو','توسع',
    // افتتاح وتوسع
    'افتتاح','افتتاح فرع','فرع جديد','خدمة جديدة','منتج جديد','مشروع جديد',
    // تكريم وجوائز
    'إنجاز فريق','إنجاز موظف','موظف مميز','فريق مميز',
    'تكريم','تكريم موظف','تكريم فريق','شهادة تقدير',
    'جائزة','حصول على جائزة','ترشيح','اعتماد','اعتماد رسمي',
    // شراكات ومبادرات
    'شراكة','اتفاقية','تعاون','مذكرة تفاهم','مبادرة','حملة',
    'رعاية','دعم','مسؤولية مجتمعية','خدمة المجتمع','تطوع','عمل تطوعي',
    // تعليم وتدريب
    'تعليم','تدريب','دورة','دورات','دورة مجانية','دورة مدفوعة',
    'تدريب مجاني','تدريب مدفوع','تدريب عملي','تدريب ميداني',
    'تدريب صيفي','تدريب مهني','تدريب تقني','تدريب إداري','تدريب وظيفي',
    // فعاليات
    'ورشة','ورشة عمل','محاضرة','ندوة','مؤتمر','لقاء',
    'جلسة تدريبية','جلسة حوارية','يوم مفتوح','معرض تعليمي','معرض مهني',
    // تسجيل وقبول ومنح
    'تسجيل مفتوح','باب التسجيل','طلبات التحاق','قبول',
    'منحة','منح','منحة تدريب','منحة تعليمية','فرصة تعليمية','فرصة تدريبية',
    // تخريج وشهادات
    'تخريج','حفل تخريج','شهادة','شهادة تدريب','شهادة خبرة',
    'اعتماد شهادة','توثيق','توثيق خبرة','توثيق شهادة',
    // مناسبات
    'فعالية','حدث','نشاط','معرض','زيارة','زيارة ميدانية','زيارة رسمية',
    'احتفال','مناسبة','حفل','تهنئة','مباركة','ترقية','ترحيب','وداع',
    'ذكرى','يوم وطني','يوم عالمي','مشاركة','دعوة عامة','دعوة حضور',
    // نصائح مهنية
    'نصيحة','نصائح','نصائح مهنية','نصائح وظيفية','إرشاد وظيفي','توجيه مهني',
    'مقابلة عمل','استعداد للمقابلة','سيرة ذاتية','CV','كتابة سيرة ذاتية','تطوير السيرة',
    // سوق العمل
    'بحث عن عمل','سوق العمل','ثقافة العمل','حقوق الموظف','واجبات الموظف',
    'بيئة مهنية','انضباط','التزام','احترافية','إنتاجية','تحفيز','إلهام',
    // تطوير مهني
    'تطوير الذات','تطوير مهني','إدارة مسار مهني','هدف','خطة','تخطيط','تنظيم',
    'مهارات','مهارات شخصية','مهارات عملية','مهارات مهنية',
    'مهارات تقنية','مهارات إدارية','مهارات تواصل','مهارات قيادة',
    // مجالات عمل
    'قيادة','إدارة','إدارة وقت','عمل جماعي','تواصل','خدمة عملاء',
    'مبيعات','تسويق','تسويق رقمي','محاسبة','موارد بشرية','إدارة مشاريع',
    'ريادة أعمال','عمل حر','فريلانس','صناعة محتوى','تصميم','برمجة',
    'تكنولوجيا','ذكاء اصطناعي','أمن معلومات','شبكات','صيانة','كهرباء','ميكانيك',
    'سلامة عامة','سلامة مهنية','صحة وسلامة','بيئة عمل','جودة','رقابة جودة',
    'إنتاج','صناعة','لوجستيات','مخازن','مستودعات','توصيل','نقل',
    'سياحة','فندقة','مطاعم','كافيهات',
    'تعليم مدرسي','تعليم جامعي','تعليم مهني','تعليم تقني',
    // أنواع دوام
    'دوام','دوام صباحي','دوام مسائي','دوام ليلي','دوام مرن','دوام جزئي','دوام كامل',
    'عمل عن بعد','عمل حضوري','عمل هجين',
    // مزايا ورواتب
    'راتب','رواتب','مزايا','حوافز','عمولات','تأمين صحي',
    'ضمان اجتماعي','بدل مواصلات','وجبات','سكن',
    // مستويات خبرة
    'خبرة','مبتدئ','متوسط الخبرة','خبير','محترف','تدريب مبتدئين','تدريب متقدم',
    // أنواع جهات
    'شركات','مؤسسات','مدارس','جامعات','معاهد','مراكز تدريب','مصانع',
    'مستشفيات','عيادات','مكاتب',
    'شركات تقنية','شركات صناعية','شركات خدمية','شركات تجارية','شركات تعليمية',
    // مسميات وظيفية
    'استقبال','خدمة','مبيعات خارجية','مبيعات داخلية','إدارة صفحات',
    'تصوير','مونتاج','كتابة محتوى','إدخال بيانات','سكرتارية',
    'استقبال عملاء','كول سنتر','دعم فني',
    'مشرف فرع','مدير فرع','مدير مبيعات','مدير موارد بشرية','مدير مالي',
    'محاسب عام','أمين صندوق','أمين مستودع','سائق توصيل','مندوب مبيعات',
    'عامل نظافة','عامل مطعم','شيف','مساعد شيف','باريستا',
    'فني كهرباء','فني تكييف','فني صيانة','فني شبكات',
    'مبرمج','مطور ويب','مصمم جرافيك','مصمم UI','مصمم UX',
    'محلل بيانات','مدخل بيانات',
    'معلم صف','معلم رياضيات','معلم لغة عربية','معلم لغة إنجليزية',
    'مدرب','مدرب مهني','مدرب تقني',
    'ممرض','صيدلي','طبيب','موظف استقبال طبي','مختبرات','أشعة',
    'هندسة','هندسة مدنية','هندسة كهربائية','هندسة ميكانيكية','هندسة برمجيات',
    'قانون','محاماة','ترجمة','علاقات عامة','مشتريات','توريد',
    'خدمة ما بعد البيع','رضا العملاء','تقييم','استبيان',
    // أنواع منشورات
    'منشور توظيف','منشور تدريبي','منشور تعليمي','منشور توعوي',
    'منشور رسمي','منشور عام','منشور إعلاني','منشور مهني',
